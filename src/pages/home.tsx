...
export default function Home() {
    return (
        ...
        <h1 className="text-center text-white my-5">QR-Pets</h1>

        <div className="row py-3 mt-6">
        <div className="col-xs-12 col-md-6">
                <img src="vet.jpg" className="w-100"/>
            </div>
            <div className="col-xs-12 col-md-6 d-flex align-items-center text-center text-white mt-3">
        ...
        <hr className="d-block d-sm-none text-white"/>
        <div className="row py-3">
        <div className="col-xs-12 col-md-6 d-flex align-items-center text-center text-white">
